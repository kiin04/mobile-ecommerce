      ...
      <form onSubmit={handleSubmit}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
           ...
           <Grid item xs={12}>
            <Typography variant="h6" sx={{ mt: 3, mb: 2 }}>Cấu hình sản phẩm</Typography>
          </Grid>
          {Object.keys(detail).map((key) => (
            <Grid item xs={12} sm={6} key={key}>
              <TextField label={key} name={key} value={detail[key]}  onChange={handleDetailChange} fullWidth margin="normal" />
            </Grid>
          ))}
       </Grid>
